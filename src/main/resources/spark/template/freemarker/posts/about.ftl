...
<html>
    ...
    <body>
    	...
    	<ul style="font-size: 26px">
        	...
        	<li style=background-color:#FFFFFF><a href="http://johannawatkins.codeguild.co/posts/about/">ABOUT</a></li>&nbsp;&nbsp;|
        	...
        	<li><a href="http://johannawatkins.codeguild.co/posts/different/">MY BLOG IS DIFFERENT</a></li>&nbsp;&nbsp;|
          	<li><a href="http://johannawatkins.codeguild.co/posts/contact.html">CONTACT</a></li>
    </ul>
        ...
        <div class="container">
            <div class="row">
                <img src="http://media.tumblr.com/c89bb90680fdc87ecd132937bf01b0e9/tumblr_inline_n78cu4p15H1s1jww5.gif" height=300px align=right>
                    ...
                    <center>
                <p> 17<br/>
                Sixth Form Student in Bournemouth<br/>
                A Levels: Mathematics, Further Mathematics, Computing, ICT<br/>
                Social Media Addict
                Aspiring Secondary School Teacher<br/>
                Master in Microsoft Office 2010<br/>
                General technology lover</p>
